...
def assign_buildings_to_nodes(nodes_gdf, buildings_gdf, radius = 80):
    """
...
def assign_global_anchors(nodes_gdf, buildings_gdf, radius = 2000, threshold = 0.3):
